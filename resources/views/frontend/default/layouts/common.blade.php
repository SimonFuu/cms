...
<head>
    ...
    <link href="/css/style.css?v={{ config('app.versions.statics')}}" rel="stylesheet" type="text/css">
</head>
<body>
@yield('body')
...
<script language="JavaScript" src="/js/app.js?v={{ config('app.versions.statics') }}"></script>
</body>
</html>