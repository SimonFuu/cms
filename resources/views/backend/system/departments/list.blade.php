                    ...
                    <div class="departments">
                        {!! Form::open(['url' => route('backend.system.departments.store'), 'method' => 'POST', 'class' => 'form-horizontal departments-submit-form', 'role' => 'form']) !!}
                            ...
                            <div class="form-group {{ $errors -> has('code') ? 'has-error' : '' }}">
                                {!! Form::label('code', '部门代码 *：', ['class' => 'control-label col-md-4']) !!}
                                <div class="col-md-8">
                            ...
                            <div class="form-group {{ $errors -> has('desc') ? 'has-error' : '' }}">
                                {!! Form::label('desc', '描述：', ['class' => 'control-label col-md-4']) !!}
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-4">
                                    <button class="btn btn-primary submitBtn" disabled type="submit">提交</button>
                                </div>
                            </div>
                        {!! Form::close() !!}
                    </div>
